...
// TTN decode for OPT3001 is as below
//  
// 'voltage' - eg. 2840 millivolts becomes 28 and in the Dashboard is decoded to 2.8 volts
//
// AmbaSat 'SENSOR_04_OPT3001' TTN Payload Decoder expects:
// decode(bytes, [lux, uint8, uint8, int16, int16, int16, int16, int16, int16, int16, int16, int16], ['lux', 'humidity', 'voltage', 'gx', 'gy', 'gz', 'ax', 'ay', 'az', 'mx', 'my', 'mz']);
