...
* AmbaSat-1 
* Filename: main.cpp
* AmbaSat Network (ASN) Flight Code for Sensor 05 - TVOC
* 13th January 2024
*
* Copyright (c) 2024 AmbaSat Ltd
* https://ambasat.com
*
* licensed under Creative Commons Attribution-ShareAlike 3.0

PLEASE NOTE:
Access to the code for ZMOD4410 requires permission from Renesas. Register at:
https://www.renesas.com/us/en/myrenesas

Once registration is confirmed, please email support@ambasat.com 
...
void  readZMOD4410()
{
        packetData.tvoc = 0;//algo_results.tvoc;
        packetData.eco2 = 0;//algo_results.eco2;
        packetData.iaq = 0;//algo_results.iaq;
        packetData.etoh = 0;//algo_results.etoh;
