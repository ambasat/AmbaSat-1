...
* AmbaSat-1 
* Filename: main.cpp
* AmbaSat-1 Flight Code Test - testing connectivity with TTN & Dashboard 
* 15th January 2022
...
*
* This code will send a dummy value of '55' using SENSOR_09_TEST  
*
* ******************************************************************************/
...
void loop()
{
   ...
   // **********************************************
    ...
    // send payload 
    ambasatLMIC->sendSensorPayload(SENSOR_09_TEST, message);  
