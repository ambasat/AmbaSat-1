...
//  
// AmbaSat 'SENSOR_09_TEST' TTN Payload Decoder expects:
// decode(bytes, [int16, uint8, int16, int16, int16, int16, int16, int16, int16, int16, int16], ['test', 'voltage', 'gx', 'gy', 'gz', 'ax', 'ay', 'az', 'mx', 'my', 'mz']);
